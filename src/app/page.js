...
const galleryItems = [
  { type: 'placeholder', caption: 'ModiFly — 3D Viewer', label: 'Video' },
  { type: 'placeholder', caption: 'PlanterBox Dashboard', label: 'Screenshot' },
  { type: 'placeholder', caption: 'MSP430 Neural Network', label: 'Demo' },
  { type: 'placeholder', caption: 'Cup Car — Race Run', label: 'Video' },
  { type: 'placeholder', caption: 'Music Glove', label: 'Demo' },
  { type: 'placeholder', caption: 'Circuit Boards', label: 'Photo' },
];
